                            ...
                            while (1) {
                                switch ((_context.prev = _context.next)) {
                                    case 0:
                                        ...
                                        imagePath = slash(
                                            path.join(parentNode.dir, node.url),
                                        );
                                        _context.next = 7;
                                        break;
                                    ...
                                    case 7:
                                        imageNode = _.find(files, function(
                                            file,
                                        ) {
                                    ...
                                    case 15:
                                        ...
                                        presentationWidth =
                                            fluidResult.presentationWidth; // Generate default alt tag
                                        ...
                                        defaultAlt = fileNameNoExt.replace(
                                            /[^A-Z0-9]/gi,
                                            ' ',
                                        );
                                        alt = overWrites.alt
                                            ...
                                            while (1) {
                                                switch (
                                                    ...
                                                    case 8:
                                                        ...
                                                        formattedImgTag = {};
                                                        formattedImgTag.url = thisImg.attr(
                                                            'src',
                                                        );
                                                        formattedImgTag.title = thisImg.attr(
                                                            'title',
                                                        );
                                                        formattedImgTag.alt = thisImg.attr(
                                                            'alt',
                                                        );
                                                    ...
                                                    case 16:
                                                        fileType = formattedImgTag.url.slice(
                                                            -3,
